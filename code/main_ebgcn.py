...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasetname', type=str, default="Weibo", metavar='dataname',
                        help='dataset name')
    ...
    parser.add_argument('--batchsize', type=int, default=64, metavar='BS',
                        help='batch size')
    parser.add_argument('--n_epochs', type=int, default=30, metavar='E',
