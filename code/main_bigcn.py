...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasetname',type=str, default="Weibo", metavar='dataname', help='dataset name')
    ...
    parser.add_argument('--n_epochs', type=int, default=20, metavar='E', help='number of max epochs')
